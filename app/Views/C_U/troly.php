...
<div class="page-heading">
    ...
    <section id="input-validation">
        ...
        <div class="row" align="center">
            <div class="col-12">
                <div class="row">
                    <h5 class="card-title" style="font-size: 300%; color: #FFF017;">SCAN QRCODE</h4>
                    <div class="col-12">
						<form action="/worker/save" method="post">
							...
							<input style="text-align:center; font-size: 300%; font-weight:bold; width:20%" type="text" class="form-control" id="valid-state" placeholder="Troly" name="Troly" autofocus required>
							<input type="submit" style="position: absolute; left: -9999px; width: 1px; height: 1px;" tabindex="-1" />
						</form>
                    </div>
                    <h5 class="card-title" style="font-size: 200%; color: #FFF017;">PLEASE SCAN QRCODE THE TROLLEY</h4>
                </div>
            </div>
        </div>
    </section>
